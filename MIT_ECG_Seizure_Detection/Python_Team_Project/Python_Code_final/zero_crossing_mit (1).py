# -*- coding: utf-8 -*-
"""Zero crossing_MIT.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1uBrdigfFFEdozEfriremx722-VygcUFB
"""
...
df_ZC=df_ZC[['FP1-F7','F7-T7','T7-P7','P7-O1','FP1-F3','F3-C3','C3-P3','P3-O1','FZ-CZ','CZ-PZ',
                                   'FP2-F4','F4-C4','C4-P4','P4-O2','FP2-F8','F8-T8','T8-P8','P8-O2']]
df_ZC=df_ZC.add_suffix('_ZC')
df_ZC['Target']=target
print(df_ZC)
df_ZC.to_csv(r'gdrive/My Drive/ZC_MIT.csv',index=False)