...
Original file is located at
    https://colab.research.google.com/drive/1SL3JFze-sN7SIfB2iZ7YkkQcoHjMqXPo
"""
...
#print(X_train)
#print(X_test)
clf = tree.DecisionTreeClassifier(criterion="entropy",max_depth=3) # create a tree object to do classification
...
x=pd.DataFrame(x,columns=["AGI","A_AGE","A_SEX","WKSWORK"])

writegraphtofile(clf, x.columns, ("0", "1"), "Census_Supplement.xlsx"+"conttree.png")